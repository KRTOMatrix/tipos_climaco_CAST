...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h2>Tipos de clima oceánico<br>Provincia de A Coruña';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
//overlays
 ...
 var relieve = L.imageOverlay('images/hillshade_cor.png',
  ...
  //{attribution: '|@Fudación Matrix 2021'}
  );
...
var tma = L.imageOverlay('images/temp_media_anual.png',
  imageBounds = [
    [44.009, -9.814],
    [42.312, -7.022]
...
tmo.setOpacity(1.0);
  ...
  var tmi = L.imageOverlay('images/temp_invierno.png',
  imageBounds = [
    [44.009, -9.814],
    [42.312, -7.022]
...
pmo.setOpacity(1.0);
  ...
  var pmi = L.imageOverlay('images/prec_invierno.png',
  imageBounds = [
    [44.009, -9.814],
    [42.312, -7.022]
...
function getColor14(a) {
	...
	a == 'fresco / muy húmedo'? '#2f74b5' : 
	a == 'fresco / hiperhúmedo'? '#1f4e78':
	a == 'templado / subhúmedo' ? '#a9d08f':
	a == 'templado / húmedo' ? '#92d14f':
	a == 'templado / muy húmedo' ? '#538234':
	a == 'templado / hiperhúmedo' ? '#385624':
	a == 'cálido / subhúmedo' ? '#fecccb':
	a == 'cálido / húmedo' ? '#ff7c81':
	a == 'cálido / muy húmedo' ? '#fe0000':
...
var geojson14 = L.geoJson(tipos,{
	...
	attribution: '<a href="https://www.fundacionmatrix.es">|<strong> @Fundación Matrix 2021</a>',
});
...
function getColor15(a) {
	...
	return a == 'verano cálido y seco/invierno templado'? '#fe0000' : 
	a == 'verano cálido y seco/invierno fresco'? '#f8cbac':
	a == 'verano cálido y seco/invierno frío' ? '#fdf2ec':
	a == 'verano cálido y húmedo/invierno templado' ? '#538234':
	a == 'verano cálido y húmedo/invierno fresco'? '#c6e0b3':
	a == 'verano suave y seco/invierno templado' ? '#ffc000':
	a == 'verano suave y seco/invierno fresco' ? '#ffff01':
	a == 'verano suave y seco/invierno frío'? '#fffed0':
	a == 'verano suave y húmedo/invierno templado' ? '#315496':
	a == 'verano suave y húmedo/invierno fresco' ? '#8fa9da':
	a == 'verano suave y húmedo/invierno frío'? '#dae1f3':
	a == 'verano fresco y húmedo/invierno templado' ? '#861b81':
	a == 'verano fresco y húmedo/invierno fresco' ? '#c245bd':
	a == 'verano fresco y húmedo/invierno frío'? '#d6a8f1':
...

{
	...
	children: [
	    ...
	    { label: "Temperatura media verano",layer: tmv},
	    { label: "Temperatura media outono",layer: tmo},
	    { label: "Temperatura media invierno",layer: tmi},
...
},
{
	...
	children:[               
		...
		{ label: "Precipitación media verano",layer: pmv},
		{ label: "Precipitación media outono",layer: pmo},
		{ label: "Precipitación media invierno",layer: pmi},
               ]
},             
...
*/	  
	...
	children: [
	    ...
	    { label: "Variantes locales de clima oceánico",layer: mapa15}
	           ]
},
...
var overlayTree = {
	...
	children: [
		...
		{ label: "Hidrografía y comunicacións", layer: positron},
		{ label: "Toponimia", layer: positronLabels},
		{ label: "Relieve", layer: relieve}
	]
};	
...
var htmlLegend3 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Temperatura media verano, <br>período 1981-2010'+"<\h3>",
			layer: tmv,
		image:'<img src="images/LOGO_GEN.png"',
...
var htmlLegend7 = L.control.htmllegend({
	...
	var htmlLegend8 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Precipitación media verano, <br>período 1981-2010'+"<\h3>",
			layer: pmv,
		image:'<img src="images/LOGO_GEN.png"',
	...
	var htmlLegend10 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Precipitación media invierno, <br>período 1981-2010'+"<\h3>",
			layer: pmi,
		image:'<img src="images/LOGO_GEN.png"',
	...
	map.addControl(htmlLegend12);
		...
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				/*label:"<h4>"+  ' muy feble'+"<\h4>",html: '',style: {'background-color': '#74b330','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
...
*/
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Tipos de clima'+"<\h3><h4><br>Basados en la temperatura y precipitación media anual. Periodo 1981-2010</h4>",
			layer: geojson14,
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
			    label:"<h4>"+  'Método: Modelización estadística e interpolación espacial. Regímenes ombrotérmicos fruto de la combinación de las variables precipitación y temperatura media anual'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				...
				label:"<h4>"+  ' Moderado'+"<\h4>",html: '',style: {'background-color': '#f4af84','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
			    label:"<h4>"+  ' Notable'+"<\h4>",html: '',style: {'background-color': '#d20105','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
				*/label: "<h5>" +'<BR><i>Fuente: CLIMACO. Elaboración propia con datos de la Agencia Estatal de Meteorología (2020).<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
	...
	map.addControl(htmlLegend14);
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Variantes locales de clima oceánico<br> '+"<\h3>",
			layer: geojson15,
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
			    label:"<h4>"+  'Método: Modelización estadística e interpolación espacial.<br>Clases basadas en el caracter térmico de los meses de julio y enero y en la concentración estival de la precipitación (período 1981-2010)'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:"<h3>"+'<br> <strong>Variantes </strong>'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {

		    	label:'<br><img src="images/variante.png",></img><br>',
				IMG:"<h3>"+  ''+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
